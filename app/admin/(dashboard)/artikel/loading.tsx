          ...
          <tbody>
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <tr key={i} className="border-b">
                <td className="p-4"><div className="w-16 h-16 bg-gray-200 rounded"></div></td>
                <td className="p-4"><div className="h-4 bg-gray-200 rounded w-full mb-2"></div><div className="h-3 bg-gray-200 rounded w-3/4"></div></td>
